...
- [ ] Facts, news hits, and results are addressed by identifier and referenced from thread state, not copied into it
- [ ] A follow-up reuses retained evidence instead of refetching it
- [ ] Any value served from thread evidence is labelled as such in the result
- [ ] A qualitative question after an analysis receives the already-computed deterministic result
- [ ] Thread state stays small as turns accumulate
